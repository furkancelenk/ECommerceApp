...
class CategoryProductsAdapter(private val onProductClick: (Product) -> Unit) :
    ListAdapter<Product, CategoryProductsAdapter.ProductViewHolder>(ProductDiffUtilCallback) {
    ...
    inner class ProductViewHolder(private var binding: ItemProductBinding) :
